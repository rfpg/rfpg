SOURCES = lerdahl.c grambidec~.c grambipan~.c grambiman~.c sinedelay~.c fibo.c gramulator~.c

LIBRARY_NAME := $(shell basename `pwd`)

# ****SUPPLY THE LOCATION OF PD SOURCE****
pd_src = /Applications/Pd-0.46.6.app/Contents/Resources/
...
ifeq ($(UNAME),Darwin)
  ...
  FAT_FLAGS = -arch arm64 -mmacosx-version-min=10.4
